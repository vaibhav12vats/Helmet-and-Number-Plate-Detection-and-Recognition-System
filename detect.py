...
# Create a table for storing the extracted text
conn.execute('''CREATE TABLE IF NOT EXISTS video_text
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        conn.execute('''INSERT INTO video_text (filename, text) VALUES (?, ?)''', ('video.mp4', text))
        conn.commit()
